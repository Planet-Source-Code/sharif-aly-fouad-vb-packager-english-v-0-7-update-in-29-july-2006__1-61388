...
Begin VB.Form Form1 
   BackColor       =   &H00FFFFFF&
   Caption         =   "Visual Basic Packger v0.7 [English] Unfinished"
   ClientHeight    =   6045
   ClientLeft      =   165
   ClientTop       =   735
   ClientWidth     =   8865
   ...
   Begin VB.Label Label4 
      BackStyle       =   0  'Transparent
      Caption         =   "This is Not Finished version and didn't complete and can't compile project file to exe .. please help to make this project done"
      BeginProperty Font 
         Name            =   "MS Serif"
         Size            =   12
         Charset         =   178
   ...
   Begin ComctlLib.ImageList imgList 
      ...
      BeginProperty Images {0713E8C2-850A-101B-AFC0-4210102A8DA7} 
         ...
         BeginProperty ListImage1 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "vbsetup.frx":7E57
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "vbsetup.frx":9499
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "vbsetup.frx":AADB
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "vbsetup.frx":C11D
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "vbsetup.frx":D75F
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "vbsetup.frx":EDA1
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin VB.Menu Project 
      ...
      Begin VB.Menu Add_Lib 
         ...
         Begin VB.Menu From_EXE 
            Caption         =   "From Exe file"
            Enabled         =   0   'False
         End
         Begin VB.Menu From_VBPROJ 
            Caption         =   "From VB Project"
            Enabled         =   0   'False
         End
...
' visual basic compile and package the visual basic project .
' this mixed up program made by sharif aly fouad and planet source code community help
Const DI_MASK = &H1
Const DI_IMAGE = &H2
...
Private Type SHELLEXECUTEINFO
  ...
  hProcess As Long
End Type
'Const AppName As String = "VBPACKAGER 1.0"
